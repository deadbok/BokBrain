...
${OBJECTDIR}/_ext/1835967288/Genetic.o: ../../src/BokBrain/src/Genetic.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g `pkg-config --cflags libglog`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1835967288/Genetic.o ../../src/BokBrain/src/Genetic.cpp

${OBJECTDIR}/_ext/1835967288/BokBrain.o: ../../src/BokBrain/src/BokBrain.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1835967288
	${RM} $@.d
	$(COMPILE.cc) -g `pkg-config --cflags libglog`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1835967288/BokBrain.o ../../src/BokBrain/src/BokBrain.cpp

${OBJECTDIR}/_ext/1835967288/NNet.o: ../../src/BokBrain/src/NNet.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1835967288
	${RM} $@.d
	$(COMPILE.cc) -g `pkg-config --cflags libglog`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1835967288/NNet.o ../../src/BokBrain/src/NNet.cpp

${OBJECTDIR}/_ext/1835967288/Neuron.o: ../../src/BokBrain/src/Neuron.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1835967288
	${RM} $@.d
	$(COMPILE.cc) -g `pkg-config --cflags libglog`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1835967288/Neuron.o ../../src/BokBrain/src/Neuron.cpp
